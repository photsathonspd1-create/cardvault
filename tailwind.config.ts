  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "hero-radial": "radial-gradient(ellipse at center right, rgba(124,58,237,0.15) 0%, rgba(9,9,11,1) 70%)",
        "gold-glow": "radial-gradient(circle, rgba(245,158,11,0.3) 0%, transparent 70%)",
      ...
      boxShadow: {
        ...
        "card-hover": "0 0 20px rgba(245,158,11,0.15)",
      },
    },
  },
